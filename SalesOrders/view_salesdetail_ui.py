...
################################################################################
## Form generated from reading UI file 'view_salesdetail.ui'
##
...
class Ui_ViewSalesDetail(object):
    def setupUi(self, Dialog):
        ...
        self.viewsalesdetail_tableView = QTableView(Dialog)
        self.viewsalesdetail_tableView.setObjectName(u"viewsalesdetail_tableView")
        self.viewsalesdetail_tableView.setGeometry(QRect(20, 120, 701, 711))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_title.setText(QCoreApplication.translate("Dialog", u"View Sales detail", None))
