...
################################################################################
## Form generated from reading UI file 'view_customerpayment.ui'
##
...
class Ui_viewcustomerpayment(object):
    def setupUi(self, Dialog):
        ...
        self.label_title.setGeometry(QRect(170, 10, 411, 61))
        font1 = QFont()
        ...
        self.viewCustomerpayment_tableView = QTableView(Dialog)
        self.viewCustomerpayment_tableView.setObjectName(u"viewCustomerpayment_tableView")
        self.viewCustomerpayment_tableView.setGeometry(QRect(0, 90, 731, 731))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_title.setText(QCoreApplication.translate("Dialog", u"View Customer Payment", None))
