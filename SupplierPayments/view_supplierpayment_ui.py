...
################################################################################
## Form generated from reading UI file 'view_supplerpayment.ui'
##
...
class Ui_view_supplierPayment(object):
    def setupUi(self, Dialog):
        ...
        self.label_title.setGeometry(QRect(200, 10, 381, 61))
        font1 = QFont()
        ...
        self.viewsupplyerpayment_tableView = QTableView(Dialog)
        self.viewsupplyerpayment_tableView.setObjectName(u"viewsupplyerpayment_tableView")
        self.viewsupplyerpayment_tableView.setGeometry(QRect(0, 90, 731, 731))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_title.setText(QCoreApplication.translate("Dialog", u"View Supplier Payment", None))
