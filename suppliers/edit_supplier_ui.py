...
################################################################################
## Form generated from reading UI file 'edit_supplier.ui'
##
...
class Ui_editsupplier(object):
    def setupUi(self, Dialog):
        ...
        self.editsupplier_button = QPushButton(Dialog)
        self.editsupplier_button.setObjectName(u"editsupplier_button")
        self.editsupplier_button.setGeometry(QRect(-10, 420, 181, 71))
        font = QFont()
        font.setPointSize(16)
        self.editsupplier_button.setFont(font)
        ...
        self.Selectsupplier_combobox.setGeometry(QRect(160, 90, 161, 26))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.editsupplier_button.setText(QCoreApplication.translate("Dialog", u"Edit Supplier", None))
        self.Back_button.setText(QCoreApplication.translate("Dialog", u"Back ", None))
        self.label.setText(QCoreApplication.translate("Dialog", u"Edit Supplier", None))
        ...
        self.selectuser_label.setText(QCoreApplication.translate("Dialog", u"Select Supplier", None))
