...
################################################################################
## Form generated from reading UI file 'view_customer.ui'
##
...
class Ui_viewcustomer(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_viewUser.setText(QCoreApplication.translate("Dialog", u"View Customer", None))
