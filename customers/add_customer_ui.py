...
class add_users_ui(object):
    def setupUi(self, Dialog):
        ...
        self.Phone_textarea = QLineEdit(Dialog)
        self.Phone_textarea.setObjectName(u"Phone_textarea")
        self.Phone_textarea.setGeometry(QRect(90, 180, 401, 41))
