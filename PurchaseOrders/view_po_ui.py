...
################################################################################
## Form generated from reading UI file 'view_po.ui'
##
...
class Ui_ViewPO(object):
    def setupUi(self, Dialog):
        ...
        self.viewpo_tableView = QTableView(Dialog)
        self.viewpo_tableView.setObjectName(u"viewpo_tableView")
        self.viewpo_tableView.setGeometry(QRect(0, 90, 731, 731))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_title.setText(QCoreApplication.translate("Dialog", u"View Purchase Order", None))
