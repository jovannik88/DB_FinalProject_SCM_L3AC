...
################################################################################
## Form generated from reading UI file 'view_purchasedetail.ui'
##
...
class Ui_viewpurchasedetail(object):
    def setupUi(self, Dialog):
        ...
        self.viewpurchasedetail_tableView = QTableView(Dialog)
        self.viewpurchasedetail_tableView.setObjectName(u"viewpurchasedetail_tableView")
        self.viewpurchasedetail_tableView.setGeometry(QRect(20, 120, 701, 711))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_title.setText(QCoreApplication.translate("Dialog", u"View Purchase detail", None))
